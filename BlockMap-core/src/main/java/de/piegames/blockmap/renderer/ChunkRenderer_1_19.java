 ...
 * @author piegames
 */
class ChunkRenderer_1_19 extends ChunkRenderer {

	private static Log log = LogFactory.getLog(ChunkRenderer_1_19.class);

	public ChunkRenderer_1_19(RenderSettings settings) {
		super(MinecraftVersion.MC_1_19, settings);
	}
